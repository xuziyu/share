	...
	<div style="margin:0 auto;width:500px;">
		...
		<div style="float:left;margin-left: 100px;">
			<form action="" id="form" method="post">
				我的订单 <br> <a href="SalOrderAction.Action">全部订单</a>&nbsp;&nbsp;&nbsp;
				<a href="SalOrderAction.Action?method=pagelistnotpay">未付款</a>&nbsp;&nbsp;&nbsp;
				<a href="SalOrderAction.Action?method=pagelistnotarrive">待收货</a>&nbsp;&nbsp;&nbsp;
				<a href="SalOrderAction.Action?method=pagelistnocomment">待评价</a> <input
					...
					<tbody>
						<c:forEach items="${page.result }" var="salOrderVO">
							<tr>
								...
								<td><a href="">查看详情</a><br /> <a href="">删除</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
