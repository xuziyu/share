...
public interface ISalOrderDao {
	...
	public void validateUnique4Code(SalOrder salOrder) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException;
